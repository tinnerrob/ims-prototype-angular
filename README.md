...
├── features/
│   ├── admin/           # Administration shell (Locations, Location Types, Categories & Types, Feature Modules)
...
│   ├── locations/       # Locations (Admin submenu: ragged parent/child hierarchy)
...
- [x] Locations — ragged location hierarchy (parent/child adjacency list), under Admin.
...
- [x] Admin — Administration shell with submenus: Locations, Location Types, Categories & Types, Feature Modules.
