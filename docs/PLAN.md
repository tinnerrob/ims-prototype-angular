...
- `check25.mjs` — **8 checks:** the pure helpers the pages print through — `statusClass` and its
...
- `check26.mjs` — **14 checks, the harness reaching past the store to a component** (P9b + P6/3 + P6/4):
  the
